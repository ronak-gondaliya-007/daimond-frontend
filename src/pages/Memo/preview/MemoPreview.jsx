        ...
        <table className='w-full'>
            <thead className='h-[44px] bg-[#FAFAFA] text-[#717680] border border-[#E9EAEB] border-x-0 border-t-0'>
                <tr className='text-[12px] font-medium'>
                    ...
                    <td className='max-w-[110px]'>Ref No</td>
            ...
            <tbody>
                {
                    table.map(({ _id, srNo, refNo, description, carat, pricePerCarat, returnInCarats, soldInCarats, price, remarks }) => (
                        <tr className='h-[60px] text-[14px] border border-[#E9EAEB] border-x-0 border-t-0' key={_id}>
                            <td className='pl-[25px] text-start'>{srNo}</td>
                            ...
                            <td className='text-center font-semibold'>{remarks}</td>
                        </tr>
                    ))
                }
