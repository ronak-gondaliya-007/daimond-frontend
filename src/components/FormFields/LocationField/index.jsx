...
const customStyles = (isError) => {
    return {
        control: (provided) => ({
            ...provided, height: '54px', borderRadius: '8px', backgroundColor: 'rgba(239, 241, 249, 0.6)', border: isError ? '1px solid #FF0000' : '1px solid #d1e9ff', fontSize: '14px',
            '&:hover': { borderColor: isError ? '#FF0000' : '#d1e9ff', boxShadow: 'none' },
