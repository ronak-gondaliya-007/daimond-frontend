...
import DiamondTable from "../../components/table";
import "../../assets/css/stock.css";

const Stock = () => {
    const headers = ['Diamond Name and ID', 'Ref No', 'Carat', 'Shape', 'Size', 'Color', 'Clarity', 'Polish'];
    const diamonds = [
        { id: 1, name: 'Diamond 1', refNo: 'Ref1', carat: 1.5, shape: 'Round', size: 1.5, color: 'E-G', clarity: 'VVS1', polish: 'VVS1' },
        { id: 2, name: 'Diamond 2', refNo: 'Ref2', carat: 1.2, shape: 'Oval', size: 1.3, color: 'F', clarity: 'VS1', polish: 'VG' },
        { id: 3, name: 'Diamond 3', refNo: 'Ref3', carat: 1.8, shape: 'Emerald', size: 1.6, color: 'D', clarity: 'IF', polish: 'EX' },
        { id: 4, name: 'Diamond 4', refNo: 'Ref4', carat: 0.9, shape: 'Pear', size: 1.1, color: 'G', clarity: 'VS2', polish: 'VG' },
        { id: 5, name: 'Diamond 5', refNo: 'Ref5', carat: 2.0, shape: 'Cushion', size: 1.7, color: 'E', clarity: 'VVS2', polish: 'EX' },
        { id: 6, name: 'Diamond 6', refNo: 'Ref6', carat: 1.1, shape: 'Marquise', size: 1.4, color: 'F', clarity: 'VS1', polish: 'VG' },
        { id: 7, name: 'Diamond 7', refNo: 'Ref7', carat: 0.7, shape: 'Heart', size: 0.9, color: 'H', clarity: 'SI1', polish: 'VG' },
        { id: 8, name: 'Diamond 8', refNo: 'Ref8', carat: 1.3, shape: 'Princess', size: 1.2, color: 'D', clarity: 'IF', polish: 'EX' },
    ...
    const handleDelete = (id) => {
        const updatedDiamonds = diamonds.filter((diamond) => diamond.id !== id);
        // setDiamonds(updatedDiamonds);
    };

    const handleEdit = (diamond) => {
        console.log('Editing diamond:', diamond);
    };
    ...
    return (
        <div>
            ...
            <div className="main-content">
                <Navbar />
                <DiamondTable data={diamonds} headers={headers} onDelete={handleDelete} onEdit={handleEdit} />
            </div>
        </div>
    );
};
